...
// Installment Intervals (period between installments in months)
export const INSTALLMENT_INTERVALS = [
  { id: 1, name: 'كل شهر', nameShort: 'شهري' },
  { id: 2, name: 'كل شهرين', nameShort: 'كل شهرين' },
  { id: 3, name: 'كل 3 أشهر', nameShort: 'ربع سنوي' },
  { id: 4, name: 'كل 4 أشهر', nameShort: 'كل 4 أشهر' },
  { id: 6, name: 'كل 6 أشهر', nameShort: 'نصف سنوي' }
];
